    ...
    <div class="header-actions">
                    ...
                    <div class="dropdown-box-list" data-simplebar>
                        ...
                        <div class="dropdown-box-list-item">
                            ...
                            <div class="user-status notification">
                                ...
                                <p class="user-status-title">
                                    <a class="bold" href="profile-timeline.html">Sarah Diamond</a> left a like <img class="reaction" src="img/reaction/like.png" alt="reaction-like" /> reaction on your
                        ...
                        <div class="dropdown-box-list-item">
                            ...
                            <div class="user-status notification">
                                ...
                                <!-- USER STATUS TITLE -->
                                <p class="user-status-title">
                                    <a class="bold" href="profile-timeline.html">The Green Goo</a> left a love <img class="reaction" src="img/reaction/love.png" alt="reaction-love" /> reaction on your
                                    <a class="highlighted" href="profile-timeline.html">status update</a>
                                </p>
                                <!-- /USER STATUS TITLE -->
        ...
        <div class="action-item-wrap">
            ...
            <div class="dropdown-navigation header-settings-dropdown">
                ...
                <a href="{{ url('/logout') }}" class="dropdown-navigation-button button small secondary">Logout</a>
                <!-- /DROPDOWN NAVIGATION BUTTON -->
            </div>
            <!-- /DROPDOWN NAVIGATION -->
        </div>
...
<nav id="navigation-widget" class="navigation-widget navigation-widget-desktop sidebar left hidden" data-simplebar>
    ...
    <div class="user-short-description">
        ...
        <a class="user-short-description-avatar user-avatar medium" href="profile-timeline.html">
            ...
            <div class="user-avatar-content">
                <!-- HEXAGON -->
                <div class="hexagon-image-82-90" data-src="{{Auth::user()->avatar}}"></div>
                <!-- /HEXAGON -->
            </div>
            <!-- /USER AVATAR CONTENT -->
...
DESCRIPTION AVATAR -->
        ...
        <p class="user-short-description-title">
            <a href="profile-timeline.html"></a>
        </p>
        <!-- /USER SHORT DESCRIPTION TITLE -->
