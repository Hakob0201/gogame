                ...
                <div class="widget-box no-padding">
                    ...
                    <div class="widget-box-status">
                        ...
                        <div class="widget-box-status-content">
                            ...
                            <div class="picture-collage">
                                ...
                                @foreach($key->post_limit as $photo)
                                ...
                                @endforeach
                                    ...
                                    <div class="picture-collage-item">
                                        ...
                                        <a class="picture-collage-item-overlay" href="profile-photos.html">
                                            ...
                                            <p class="picture-collage-item-overlay-text">{{count($key->post_photo)}}</p>
                                            <!-- /PICTURE COLLAGE ITEM OVERLAY TEXT -->
                                        </a>
                                        <!-- /PICTURE COLLAGE ITEM OVERLAY -->
                                        ...
                                        <div class="photo-preview">
                                            <!-- PHOTO PREVIEW IMAGE -->
                                            <figure class="photo-preview-image liquid">
                                                <img src="{{$key->post_photo[0]->name}}" alt="photo-preview-14" style="display: none;">
                                            </figure>
                                            <!-- /PHOTO PREVIEW IMAGE -->
                    ...
                    <div class="post-options">
                        ...
                        <div class="post-option-wrap">
                            ...
                            <div class="reaction-options reaction-options-dropdown" data-value="p_{{ \Crypt::encryptString($key->id) }}">
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('like') }}" data-title="Like">
                                ...
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('love') }}" data-title="Love">
                                    <!-- REACTION OPTION IMAGE -->
                                ...
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('dislike') }}" data-title="Dislike">
                                    <!-- REACTION OPTION IMAGE -->
                                ...
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('happy') }}" data-title="Happy">
                                    <!-- REACTION OPTION IMAGE -->
                                ...
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('funny') }}" data-title="Funny">
                                    <!-- REACTION OPTION IMAGE -->
                                ...
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('wow') }}" data-title="Wow">
                                    <!-- REACTION OPTION IMAGE -->
                                ...
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('angry') }}" data-title="Angry">
                                    <!-- REACTION OPTION IMAGE -->
                                ...
                                <!-- REACTION OPTION -->
                                <div class="reaction-option text-tooltip-tft _smail" data-value="{{ \Crypt::encryptString('sad') }}" data-title="Sad">
                                    <!-- REACTION OPTION IMAGE -->
                        ...
                        <!-- POST OPTION -->
                        <div class="post-option o_p_c" value="{{ \Crypt::encryptString($key->id) }}">
                            <!-- POST OPTION ICON -->
